"""Simple and reliable book generator using only OpenAI API"""
import os
import sys
import time
import traceback
...
# Create a log file
log_file = open("simple_book_debug.txt", "w")
def log(message):
...
def main():
    try:
        log("Starting simple book generator...")
...
"""
        ...
        log("✓ Created complete book file: book_output/complete_book.txt")
        ...
        log_file.close()
        print("\nProcess complete. Check simple_book_debug.txt for details.")
